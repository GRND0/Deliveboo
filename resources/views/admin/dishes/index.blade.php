...
<div class="container">
    ...
    <span>(i piatti visualizzati in rosso non sono disponibili per l'acquisto da parte dei clienti)</span><br>
    ...
    <div class="row row-cols-4">
        @foreach ($dishes as $dish)
            <div class="col-12 col-sm-6 col-lg-3 card-group">
                <div class="card mb-4 @if ($dish->available == false) border border-3 border-danger @endif">
                    @if ($dish->image)
